...
const content = {
  en: {
    ...
    steps: [
      ...
      {
        number: 'Step 2',
        title: 'Freeze your tokens in the wallet',
        description: `As an early adopter, you can stake your Legacy Token (LGCT)s for 6, 12 or 24 months in the Legacy wallet (coming soon).`,
      },
      {
        number: 'Step 3',
        title: 'Get rewarded',
