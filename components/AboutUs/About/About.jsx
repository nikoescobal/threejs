        ...
        <div className={`${styles['tabs-wrapper']}`}>
          ...
          >
            ...
            <p>
              ...
              building international communities around personal development. We
              firmly believe that personal development is the key to success in
              all life areas, as well as the solution for many global problems.
              For this reason, we committed ourselves to find new ways in order
              to provide something of true value to the world.Our central
              product is a gamified education app, which uses a play-to-earn
              system to reward its users with crypto. The app is powered by the
              first ever artificial intelligence, which analyses several aspects
              of a user&apos;s personality and reflects the collected
          ...
          >
            ...
            <p>
              ...
              a successful and fulfilling life. Great technology should work for
              the user, not against him. We live in an era, where big tech
              companies know much more about us and our psychology, than we do.
              This valuable data is used to sell us more products and to make us
              neurologically addicted to certain services. We aim to create a
              technology, which collects the same data but provides it to the
              user, A technology, developed to give people deep insights into
              the programming and functionality of their own brain along with
              individual and playful step by step guidance on how to use the new
          ...
          >
            ...
            <p>
              ...
              quality of life but are not recognized as an illness. The average
              person today is plagued by: Diverse anxieties, sleep disturbances,
              recurring negative emotions as well as poor physical condition.
              These matters in turn negatively impact his success in various key
              areas of life. We humans tend to perceive certain circumstances as
              &ldquo;not so bad&rdquo; as far as most of them are concerned. In
              reality, the facts mentioned have disastrous consequences both for
              the individuals affected and for society as a whole.
            </p>
            <br />
            <p>
              Aggression, hatred and criminality within society are largely due
              to frustration. Frustration, in turn, can be attributed mainly to
              a lack of success in important areas of life. The main reason for
              the described problem lies mainly in the human preference for
              short-term gratification over long-term success, happiness and
              long-term health as a basic condition. In general, it can be said
              that the average person of today is trapped in a state of aimless
              distraction and lacks the necessary strategies and tools to escape
              from it.
            </p>
          </TabPanel>
          <TabPanel
          ...
          >
            ...
            <p>
              ...
              behavior as well as that of his fellow people and teaches him step
              by step effective life strategies. The user learns important
              skills that supports him actively and independently to create a
              fulfilling and successful life. The content is mainly from the
              fields of psychology, sociology, neurology and biology. The
              contents originate from experts and is subject to strict quality
              control. Our goal with the play-to-earn system is for the user to
              not view the learning process as an expense. Even though we have
              no direct competition in terms of the technology, we still compete
              with other companies for the user&apos;s attention.
            </p>
            <br />
            <p>
              A big problem of our time is the neurological dependence on
              dopamine, or short-term reward release in the brain. By designing
              our system to create what in this case is a positive dependency,
              we ensure that our ecosystem is actively used and that the user
