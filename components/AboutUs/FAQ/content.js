    ...
    content: [
      {
        ...
        answer:
          '<p>Legacy Network is an international technology company from Liechtenstein. We firmly believe that personal development is the key to success in all life areas, as well as the solution for many global problems. Our goal is to create an environment where positive personal development for every single person is easily accessible and possible, for this reason, we committed ourselves to find new ways in order to provide something of true value to the world.</p>',
      },
      {
        question: 'What is our vision?',
        answer:
          "<p>Our vision is to create the world's biggest personal development ecosystem with our technology as the gate to a successful and fulfilling life. Great technology should work for the user, not against him. In today's era, big tech companies know much more about us and our psyche than we do. This data is used to sell us more products and leads us to addiction to certain services. We aim to create a technology, which collects the same data but provides it to the user. A technology, developed to give people deep insights into the programming and functionality of their own brain along with individual and playful step by step guidance on how to apply the new gained knowledge.</p>",
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>The native chain is Ve-Chain, additionally, the token will be available on:</p> <ul><li>Binance Smart Chain</li> <li>Ethereum</li> <li>Polygon/Matic</li></ul>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>Yes, we are currently preparing the ICO which is expected to start in September.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>Yes, our goal is to make the LGCT token easily tradable for everyone. At first, we will list on a few small exchanges and as soon as all requirements (trading volume, awareness, etc.) are met, we hope to get listed on the big exchanges such as Binance and Coinbase as well.</p>',
      },
      {
        question: 'Why do we need a NFT?',
        answer:
          '<p>Our goal is to break common patterns and to make our app as playful as possible. For this purpose, there will be an animated 3D character that mirrors the user and his progress. He will serve as the central character within the app and can grow in his level, just like the user grows in real life. We plan to release a NFT collection where the NFT can be loaded into the app as an avatar. People who own one of our NFTs will get access to various utilities. The NFT collection is divided into different variety levels, this applies to both the design and the benefits that are unlocked.</p><ul><li>Life Time Free App Access</li><li>A higher play to earn reward within the app</li><li>In-App Features that are only accessible to NFT owners</li><li>Access to our Network</li><li>More utility will be announced in future</li></ul>',
      },
      {
