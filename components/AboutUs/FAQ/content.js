    ...
    content: [
      {
        ...
        answer: "<p>Legacy Network is an international technology company from Liechtenstein. We firmly believe that personal development is the key to success in all life areas, as well as the solution for many global problems. Our goal is to create an environment where positive personal development for every single person is easily accessible and possible, for this reason, we committed ourselves to find new ways in order to provide something of true value to the world.</p>"
      },
      {
      ...
      },
      {
        ...
        answer: "<p>The native chain is Ve-Chain, additionally, the token will be available on:</p> <ul><li>Binance Smart Chain</li> <li>Ethereum</li> <li>Polygon/Matic</li></ul>"
      },
      {
      ...
      },
      {
        ...
        answer: "<p>Yes, we are currently preparing the ICO which is expected to start in September.</p>"
      },
      {
