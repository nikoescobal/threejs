const content = {
  en: [
    ...
    },
    {
      ...
      content: [
        {
          question: "What actions do we take to prevent us from a potential crisis?",
  ...
  de: [
      ...
      content: [
        {
          ...
          answer: `<p>Legacy Network ist ein internationales
          Technologieunternehmen aus
          Liechtenstein. Wir sind fest davon
          überzeugt, dass persönliche Entwicklung
          der Schlüssel zum Erfolg in allen
          Lebensbereichen sowie die Lösung für viele
          globale Probleme ist. Unser Ziel ist es, eine
          Umgebung zu schaffen, in der positive
          persönliche Entwicklung für jede einzelne
          Person leicht zugänglich und möglich ist.
          Aus diesem Grund haben wir uns
          verpflichtet, neue Wege zu finden, um der
          Welt etwas von wahrem Wert zu bieten.</p>`
        },
        {
          question: 'Was ist unsere Vision?',
          answer: `<p>Unsere Vision ist es, mit unserer
          Technologie das Tor zu einem erfolgreichen
          und erfüllenden Leben und dem größten
          Ökosystem für persönliche Entwicklung der
          Welt zu schaffen. Großartige Technologie
          sollte für den Benutzer arbeiten und nicht
          gegen ihn. Wir leben in einer Ära, in der
          große Technologieunternehmen viel mehr
          über uns und unsere Psychologie wissen,
          als wir selbst. Diese wertvollen Daten
          werden verwendet, um uns mehr Produkte
          zu verkaufen und uns neurologisch an
          bestimmte Dienste zu gewöhnen. Wir
          möchten eine Technologie entwickeln, die
          die gleichen Daten sammelt, sie dem
          Benutzer jedoch zur Verfügung stellt. Eine
          Technologie, die entwickelt wurde, um den
          Menschen tiefe Einblicke in die
          Programmierung und Funktionsweise ihres
          eigenen Gehirns sowie individuelle und
          spielerische Schritt-für-Schritt-Anleitungen
          darüber zu geben, wie sie das neu
          gewonnene Wissen zu ihrem Vorteil nutzen
          können.</p>`
        },
        {
          question: 'Wie generieren wir Wert?',
          answer: `<p>Menschen zusammenzubringen, um das
          Beste aus ihnen herauszuholen und globale
          Probleme der psychischen Gesundheit
          anzugehen, ist unser Weg, unserer Welt
          Wert hinzuzufügen. In der persönlichen
          Entwicklung geht es darum, ein tiefes
          Verständnis für unsere eigene Psyche sowie
          die menschliche Natur im Allgemeinen zu
          erlangen. Das Ziel ist es, schädliche
          Eigenschaften bei uns selbst zu finden, zu
          verstehen, wie sie uns daran hindern, in
          verschiedenen Bereichen erfolgreich zu
          sein, und sie schrittweise durch effektivere
          Eigenschaften zu ersetzen.</p>`
        },
        {
          question: 'Auf welcher Blockchain wird der LGCN-Token verfügbar sein?',
          answer: `<p>Die native Chain ist <b>Ve-Chain</b>, zusätzlich
          wird der Token auf folgenden Blockchains
          verfügbar sein:</p> <ul><li>Ve-Chain</li><li>Binance Smart Chain</li> <li>Ethereum</li> <li>Polygon/Matic</li></ul>`
        },
        {
          question: 'Warum haben Sie diese Blockchains ausgewählt?',
          answer: `<p>Die Idee hinter mehreren Blockchains ist es,
            möglichst viele Menschen zu erreichen und
            die individuellen Funktionen jeder
            Blockchain zu nutzen. Außerdem arbeiten
            wir mit Safehaven zusammen, einem
            kompetenten Partner, der sichere DeFi-
            Lösungen wie eine multichain-Bridge für
            sichere atomare Swaps zwischen den
            Blockchains anbietet.</p>`
        },
        // {
        //   question: 'Will there be a public sale (ICO)?',
        //   answer: "<p>Yes, we are currently preparing the ICO, more details for it will be announced on our social media and in our community channels.</p>"
        // },
        {
          question: 'Wird der Token auf CEX handelbar sein?',
          answer: "<p>Ja.</p>"
        },
        // {
        //   question: 'Will there be other listings in the future?',
        ...
        // },
        {
          ...
          answer: `<p>Unser Ziel ist es, gängige Muster zu durchbrechen und unsere App so spielerisch wie möglich zu gestalten. Dazu wird es einen animierten 3D-Charakter geben. Der Avatar wird als zentraler Charakter innerhalb der App dienen und kann sein Level genau wie der Benutzer im realen Leben steigern. Wir planen, eine NFT-Sammlung zu veröffentlichen, in der das NFT als Avatar in die App geladen werden kann. Menschen, die eines unserer NFTs besitzen, erhalten Zugang zu verschiedenen Errungenschaften (Nützlichkeiten) zusammen mit dem Charakter. Die NFT-Sammlung ist in verschiedene Variationsstufen unterteilt. Dies gilt sowohl für das Design als auch für die freigeschalteten Vorteile.</p>
          <ul>
            <li>Eine höhere Belohnung für das Erarbeiten innerhalb der App</li>
            <li>In-App-Funktionen, die nur für NFT-Besitzer zugänglich sind</li>
            <li>Zugang zu unserem Netzwerk</li>
            <li>Weitere Funktionen werden noch bekanntgegeben</li>
          </ul>`
        },
    ...
    },
    {
      ...
      content: [
        ...
        {
          question: 'Was ist der Mint Preis?',
          answer: "<p>TBA (zu gegebener Zeit bekanntgegeben)</p>"
        },
        {
          question: 'Auf welcher Blockchain werden die NFTs gestartet?',
          answer: "<p>Ethereum</p>"
        },
        {
          question: 'Wann wird das Produkt gestartet?',
          answer: "<p>TBA</p>"
        },
        {
          question: 'Wird es auf allen Plattformen verfügbar sein?',
          answer: "<p>TBA</p>"
        },
        {
          question: 'Wann kann ich das Produkt testen?',
          answer: "<p>TBA</p>"
        },
        {
          question: 'Was macht Legacy Network einzigartig?',
          answer: "<p>Legacy Network ist die weltweit erste Technologie zur persönlichen Entwicklung, die in der Lage ist, alle Bereiche des Lebens einer Person nachhaltig und effektiv zu verbessern. Sie bietet den besten verfügbaren Inhalt, persönliche Anleitung und ein wertvolles Netzwerk von Gleichgesinnten auf einmal. Darüber hinaus nutzt es ein einzigartiges Bildungssystem und neurologische Auslöser, um sicherzustellen, dass der Benutzer Spaß hat und engagiert bleibt.</p>"
        },
        {
          question: "Welche Methode verwenden Sie?",
          answer: "<p>Unser Ansatz ist es ein Spiel zu erstellen. Benutzer können ihren Ingame-Charakter leveln, während sie gleichzeitig im realen Leben leveln.</p>"
        },
        {
          question: "Woher stammt der Inhalt?",
          answer: "<p>Unser Inhalt ist eine Sammlung der Gedanken der größten Wissenschaftler und Experten. Neu geschrieben auf eine einzigartige Weise und verarbeitet, um unserem System zu entsprechen.</p>"
        },
        {
          question: "Was ist geplant für die Zukunft?",
          answer: `<p>In Zukunft haben wir unzählige Möglichkeiten, unser Ökosystem auszubauen, um unseren Nutzern noch mehr Nutzen zu bieten. Wir arbeiten derzeit an vielen großartigen Dingen, die jedoch noch nicht öffentlich angekündigt wurden. Es ist uns wichtig, dass wir unsere Versprechen halten können, deshalb werden wir niemals Dinge ankündigen, die nicht vollständig ausführbar sind.
          </p>`
        },
      ]
    },
    {
      ...
      content: [
        {
          question: "Was macht Ihr um eine potenzielle Krise abzuwinden?",
          answer: `<p>Um einer potenziellen Krise vorzubeugen, gibt es leider nicht viel was man tun kann, da 90% der Krypto-Projekte einen großen Crash nicht überstehen. Der Hauptgrund dafür ist, dass die meisten dieser Projekte stark von Hype und der Krypto-Marktentwicklung abhängig sind. Ein zweiter Grund ist, dass viele Projekte kurzlebige Unterhaltungsprodukte schaffen, wo kein dringender Bedarf besteht. Wir sind jedoch krisensicher, aufgrund folgender Gründe:
          </p>
          <ul>
            <li>
              Wir sind nicht unbedingt ein Krypto-Unternehmen, sondern ein Technologieunternehmen, das Krypto/Blockchain-Integration verwendet, um sein Ökosystem wertvoller zu machen. Wir haben mehrere verschiedene Einkommensströme und Erweiterungsmöglichkeiten, was bedeutet, dass wir weniger von Marktschwankungen betroffen sind.
            </li>
            <li>
              Unser Ökosystem ist ein Problem-Löser, der mehrere dringende Bedürfnisse befriedigt und auf globale Probleme reagiert, die von Jahr zu Jahr schlimmer werden. Produkte, die nicht nur für eine bestimmte Zeit gewünscht, sondern benötigt werden, sind langlebiger. Dies trägt zur Stärke unserer Fundamente bei.
            </li>
          </ul>`
        },
        {
          question: "Wie kann der LGCT Token genutzt werden?",
          answer: `<p>
          Der LGCT-Token kann innerhalb des Legacy Network Ökosystems als Zahlungs- und Utility-Token verwendet werden. Sein Hauptzweck ist es, unsere Nutzer dazu zu ermutigen, unser Ökosystem aktiv zu nutzen und zu seinem Wachstum beizutragen. Eines der hauptsächlichen Probleme, mit denen die Welt derzeit konfrontiert ist, ist die neurologische Abhängigkeit von kurzfristiger Belohnungsfreisetzung im Gehirn, auch als kurzfristige Befriedigung bekannt. Daher verwenden wir LGCN Token als Belohnung innerhalb unseres Bildungssystems, um einen unterhaltsamen und befriedigenden Effekt zu erzielen.
          </p>
          <br />
          <p>
            Der LGCN Token kann für verschiedene Zwecke verwendet werden, wie z.B. für In-App-Käufe wie das Freischalten zusätzlicher Funktionen, für Staking, um Zugang zu besonderen Belohnungen und Nutzen zu erhalten, für den Kauf von Produkten in unserem Online-Shop und mehr.
          </p>
          // <ul>
          //   <li>
